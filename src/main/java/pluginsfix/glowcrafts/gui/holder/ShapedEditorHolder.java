...
public final class ShapedEditorHolder implements GlowHolder {
    ...
    public ShapedEditorHolder(Messages messages, RecipeEngine recipeEngine, ChatInputHandler chatInput, PluginConfig config, String id) {
    ...
    public static void openNew(Player player, Messages messages, RecipeEngine recipeEngine, ChatInputHandler chatInput, PluginConfig config) {
        ...
        Inventory inv = Bukkit.createInventory(holder, 54, messages.componentWithoutPrefix("gui.editor.title-shaped"));
    ...
    public static void openEdit(Player player, Messages messages, RecipeEngine recipeEngine, ChatInputHandler chatInput, PluginConfig config, CraftRecipe recipe) {
        ShapedEditorHolder holder = new ShapedEditorHolder(messages, recipeEngine, chatInput, config, recipe.id());
